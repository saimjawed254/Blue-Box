  ...
  return (
    <>
      {/* <Link href={link}
        ...
        className={`square-button center ${ibm_plex_mono.className}`}
      >
        <svg
        ...
        >
          <path
            ...
            fill="rgb(var(--pure-black))"
          />
        </svg>
        &nbsp;Show All&nbsp;
      </Link> */}

      <div className="square-button center">
        <Link href={link} className={`square-button-inner nav-link ${ibm_plex_mono.className}`}>
          <span className="dot-fill"></span>
          <span className="nav-label">• Show all</span>
        </Link>
      </div>
    </>
  );
