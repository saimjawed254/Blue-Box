    ...
    <>
      <div className="product-card">
        ...
        <div className={`product-info ${poppins.className}`}>
          <div className="product-company">Levis</div>
          <div className="product-quantity center">Qty: 2</div>
          <div className="product-title">Green Denim Cargo</div>
          <div className="product-price">
            <span className="product-price-discounted">
              &#x20B9;849&nbsp;&nbsp;&nbsp;
            </span>
            <span className="product-price-original">&#x20B9;1499 </span>
            <span className="product-discount">&nbsp;&nbsp;&nbsp;43% off</span>
          </div>
